...
namespace Web.App.Security.ViolationHandlers
{
	public class DenyAuthenticatedAccessPolicyViolationHandler : IPolicyViolationHandler
	{
		...
		public DenyAuthenticatedAccessPolicyViolationHandler(ILogger logger)
		{
			_logger = logger;
		}
		...
		public ActionResult Handle(PolicyViolationException exception)
		{
			...
			_logger.Log("Authenticated access denied to {0}Controller {1}.", controllerName, actionName);
